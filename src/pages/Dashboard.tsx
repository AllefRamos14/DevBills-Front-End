...
const Dashboard = () => {
	...
	const renderPieChatLabel = ({ name, percent }: PieLabelRenderProps) => {
		...
		<div className="container-app py-6">
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
				...
				<CardResumo
					...
					hover
				>
					<p className="text-2x1 font-semibold mt-2 text-primary-500">
				...
				<CardResumo
					...
					hover
				>
					<p className="text-2x1 font-semibold mt-2 text-red-600">
